<%-- 
    ...
    Created on : 15/08/2020, 04:01:26 PM
    Author     : Jean
--%>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form name="AgregarCursosForm" action="Controlador" method="get" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <input class="form-control" type="text" name="f_horas" value="" maxlength="50"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="3" class="col-sm-2 control-label">Creditos</label>
                            <div class="col-md-3">
                              <input class="form-control" type="text" name="f_creditos" value="" maxlength="8" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <input class="btn btn-primary" type="submit" value="Agregar Curso" name="agregar" />
            ...
            <div class="row">
                <ol class="breadcrumb">
                        ...
                        <li class="active">Agregar Curso</li>
                </ol>
            </div>
        </div>
    </body>
